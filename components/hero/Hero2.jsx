			...
			<div className="relative items-start text-center md:overflow-x-hidden overflow-x-hidden bg-[#F8F8F8] px-5 md:px-20">
				...
				<div className="flex-wrap md:flex justify-center gap-12 my-10 mx-32 items-center">
					...
					<div className="content flex-wrap w-full text-center md:text-left">
						...
						<p>{about}</p>
						<div className="text-black font-bold text-[20px] mt-6">Motto</div>
						<p>{motto}</p>
					</div>
				</div>
				<div id="content2 mt-20">
					<div className="flex justify-evenly flex-wrap w-[100%] mt-10 items-center gap-6">
						<div className="w-[35%]">
							<span className="text-primary font-bold text-[40px] ">
								Kenapa Harus Kami
							</span>
							<p>
