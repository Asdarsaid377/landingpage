		...
		<>
			<nav className="w-full flex-1 flex h-[100px] items-center justify-between navbar">
				<div className="flex ml-16 items-center justify-center">
					...
					/>
					<Link href="/">
						<span className="cursor-pointer ml-3 font-bold text-sm md:text-xl">
							{name}
						</span>
					</Link>
				</div>
				...
				<div className="flex justify-center mr-16">
					<div
						className="flex w-[205px] hover:scale-110 mr-4 hover:cursor-pointer h-[48px] ml-10 border-[#4F9D4E] border-[3px] 
        bg-white items-center justify-center rounded-[28px]">
						<img src={logos} className="w-[30px] h-[30px]" />
